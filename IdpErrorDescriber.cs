...
namespace WebApplication2
{
    ...
    /// </summary>
    ///<remarks>
    ///These errors are returned to controllers and are generally used to edisplay messages to end users
    /// </remarks> 
    ///
    public class IdpErrorDescriber : IdentityErrorDescriber
    {
        private readonly LocService _sharedLocalizer;

        public IdpErrorDescriber(LocService sharedLocalizer)
        {
